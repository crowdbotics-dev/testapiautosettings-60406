...
## Project Structure
    ...
    ├── testapiautosettings_60406  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_60406`
...
2. Clone this repo and `cd testapiautosettings_60406`
